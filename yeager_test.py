...
from yeager import walk, enumerate_transitions, nodes, edges
...
walk(driver=webdriver.Chrome(), exit_state="contact-page")
#enumerate_transitions()

from graph_tool.all import *

def graph():
    #render graph (needs cleanup but is good.)
    g = Graph()
    g.set_directed(True)
    ...
    pos = arf_layout(g)
    graph_draw(g, pos=pos, output_size=(1920,1080), vertex_text=v_node_map, edge_text=e_map, vertex_size=1, edge_pen_width=1)
